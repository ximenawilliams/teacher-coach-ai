...
:: Configuración de variables según el idioma
if "%lang%"=="1" goto english
if "%lang%"=="2" goto spanish
goto english :: Default a Inglés si meten un número raro
...
set MSG_STEP2=[2/3] Verifying AI model (gemma2:2b)...
...
set MSG_STEP2=[2/3] Verificando modelo de IA (gemma2:2b)...
